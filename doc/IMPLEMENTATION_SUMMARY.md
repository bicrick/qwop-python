...
### 1. Performance Optimizations (`qwop_python/game.py`, `qwop_python/physics.py`)
...
### 2. Gymnasium Environment (`qwop_python/qwop_env.py`)
...
### 3. Reward Shaping Wrappers (`qwop_python/wrappers/`)
...
**Created:**
- `qwop_python/qwop_env.py` (241 lines)
- `qwop_python/wrappers/__init__.py` (7 lines)
- `qwop_python/wrappers/reward_shaping_wrapper.py` (289 lines)
- `train.py` (308 lines)
...
**Modified:**
- `qwop_python/game.py` - Added `verbose` and `headless` parameters
- `qwop_python/physics.py` - Added `verbose` parameter
